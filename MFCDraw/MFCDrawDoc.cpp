...
void CMFCDrawDoc::Serialize(CArchive& ar)
{
	...
	{
		// TODO:  在此添加加载代码
		//Rotation_img = new Image(ar.GetFile()->GetFilePath());
		//Rotation_img = Gdiplus::Image::FromFile(ar.GetFile()->GetFilePath());
		ImagePath = ar.GetFile()->GetFilePath();
			
		//Bool result = LoadResImage()
	}
}
